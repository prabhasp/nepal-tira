...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_31655 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_31655(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_31660 = (function (port,val,fn1_handler){
var x__5393__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_31660(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_31667 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_31667(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_31669 = (function (chan){
var x__5393__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_31669(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_31672 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_31672(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_31676 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_31676(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_31679 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_31679(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_31682 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_31682(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_31683 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_31683(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_31684 = (function (b,itm){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_31684(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_31686 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_31686(b);
}
});

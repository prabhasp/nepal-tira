...
var len__5769__auto___29132 = arguments.length;
var i__5770__auto___29133 = (0);
while(true){
if((i__5770__auto___29133 < len__5769__auto___29132)){
args__5775__auto__.push((arguments[i__5770__auto___29133]));

var G__29134 = (i__5770__auto___29133 + (1));
i__5770__auto___29133 = G__29134;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq29077){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29078,G__29079,seq29077__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__29103_SHARP_){
return (!((cljs.core.meta(p1__29103_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29118__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e29119){var _e__27947__auto__ = e29119;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e29121){var _e__27947__auto__ = e29121;
return false;
}}
})())){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29126__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
var temp__5802__auto___29153 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___29153)){
var managed_print_level_29154 = temp__5802__auto___29153;
var _STAR_print_level_STAR__orig_val__29128_29155 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__29129_29156 = managed_print_level_29154;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__29129_29156);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__29127_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__29127_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__29128_29155);
}} else {
job_fn();
}

...
var _STAR_print_newline_STAR__orig_val__30490_30632 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__30491_30633 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__30492_30634 = true;
var _STAR_print_fn_STAR__temp_val__30493_30635 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__30492_30634);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__30493_30635);

try{var _STAR_print_level_STAR__orig_val__30495_30636 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__30496_30637 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__30496_30637);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__30495_30636);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__30491_30633);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__30490_30632);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq30480){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq30480));
}));
...
var new_formatters = current_formatters.filter((function (p1__30552_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__30552_SHARP_)));
}));
...
var G__30561_30659 = f;
var target__27939__auto___30660 = G__30561_30659;
if(cljs.core.truth_(target__27939__auto___30660)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30561_30659)].join(''),"\n","target__27939__auto__"].join('')));
}

(target__27939__auto___30660["toString"] = (function (){
...
var G__30563_30665 = "%c%s";
var G__30564_30666 = "color:transparent";
var G__30565_30667 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__30563_30665,G__30564_30666,G__30565_30667) : f.call(null,G__30563_30665,G__30564_30666,G__30565_30667));
...
while(true){
if((i__5770__auto___30674 < len__5769__auto___30672)){
...
var vec__30578 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30578,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30578,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__30678__delegate = function (add_fmt,add_args){
...
var G__30678 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__30680__i = 0, G__30680__a = new Array(arguments.length -  1);
while (G__30680__i < G__30680__a.length) {G__30680__a[G__30680__i] = arguments[G__30680__i + 1]; ++G__30680__i;}
  add_args = new cljs.core.IndexedSeq(G__30680__a,0,null);
} 
return G__30678__delegate.call(this,add_fmt,add_args);};
G__30678.cljs$lang$maxFixedArity = 1;
G__30678.cljs$lang$applyTo = (function (arglist__30681){
var add_fmt = cljs.core.first(arglist__30681);
var add_args = cljs.core.rest(arglist__30681);
return G__30678__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq30573){
...
var G__30576 = cljs.core.first(seq30573__$2);
var seq30573__$3 = cljs.core.next(seq30573__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30574,G__30575,G__30576,seq30573__$3);
}));
...
var seq__30584 = cljs.core.seq(features);
var chunk__30585 = null;
var count__30586 = (0);
var i__30587 = (0);
while(true){
if((i__30587 < count__30586)){
var feature = chunk__30585.cljs$core$IIndexed$_nth$arity$2(null,i__30587);
...
var G__30684 = seq__30584;
var G__30685 = chunk__30585;
var G__30686 = count__30586;
var G__30687 = (i__30587 + (1));
seq__30584 = G__30684;
chunk__30585 = G__30685;
count__30586 = G__30686;
i__30587 = G__30687;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__30584);
if(temp__5804__auto__){
var seq__30584__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__30584__$1)){
var c__5568__auto__ = cljs.core.chunk_first(seq__30584__$1);
var G__30689 = cljs.core.chunk_rest(seq__30584__$1);
var G__30690 = c__5568__auto__;
var G__30691 = cljs.core.count(c__5568__auto__);
var G__30692 = (0);
seq__30584 = G__30689;
chunk__30585 = G__30690;
count__30586 = G__30691;
i__30587 = G__30692;
continue;
} else {
var feature = cljs.core.first(seq__30584__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__30693 = cljs.core.next(seq__30584__$1);
var G__30694 = null;
var G__30695 = (0);
var G__30696 = (0);
seq__30584 = G__30693;
chunk__30585 = G__30694;
count__30586 = G__30695;
i__30587 = G__30696;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5802__auto__)){
var o30606 = temp__5802__auto__;
return (o30606["version"]);
} else {
return null;
}
})() == null);

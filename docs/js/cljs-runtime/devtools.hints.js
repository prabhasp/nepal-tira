...
var map__28862 = top_item;
var map__28862__$1 = cljs.core.__destructure_map(map__28862);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28862__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28862__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28862__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e28861){var _e = e28861;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5802__auto___28931 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5802__auto___28931)){
var seen_errors_28932 = temp__5802__auto___28931;
if(cljs.core.truth_(seen_errors_28932.has(self))){
} else {
seen_errors_28932.add(self);

var temp__5804__auto___28933 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5804__auto___28933)){
var sense_28934 = temp__5804__auto___28933;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_28934)].join(''));
} else {
}
}
} else {

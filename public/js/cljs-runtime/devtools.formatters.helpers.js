...
var G__29065 = devtools.prefs.pref(v);
v = G__29065;
continue;
} else {
return v;
...
}catch (e29027){var _e__27947__auto__ = e29027;
return false;
}})();
...
}catch (e29030){var _e__27947__auto__ = e29030;
return false;
}})();
...
}catch (e29033){var _e__27947__auto__ = e29033;
return false;
}}
}
});
...
var vec__29035 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29035,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29035,(1),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__29038_SHARP_);
}),template);
});

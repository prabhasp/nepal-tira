...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_37944 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_37944(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_37945 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_37945(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_37946 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_37946(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_37947 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_37947(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_37952 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_37952(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_37953 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_37953(reader);
}
});
...
var G__37997 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__37998 = s.append(c);
c = G__37997;
s = G__37998;
continue;
}
